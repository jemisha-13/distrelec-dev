...
import { GlobalMessageEntities, GlobalMessageService, GlobalMessageType, I18nTestingModule } from '@spartacus/core';
...
describe('GlobalMessageComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      providers: [{ provide: GlobalMessageService, useClass: MockMessageService }],
    }).compileComponents();
  }));
  ...
  it('Should be able to remove messages', () => {
    ...
    expect(messageService.remove).toHaveBeenCalledWith(GlobalMessageType.MSG_TYPE_CONFIRMATION, 0);
  });
});
