import { Occ, PriceType } from '@spartacus/core';
...
export const MOCK_ORDER_DATA: Order = {
  type: 'orderWsDTO',
  billingAddress: {
    billingAddress: true,
  ...
  entries: [
    {
      ...
      product: {
          ...
          image: [
            {
              key: 'brand_logo',
              value: {
                format: 'brand_logo' as ImageFormat,
        ...
        energyEfficiencyLabelImage: [
          {
            key: 'landscape_large',
            value: {
              format: 'landscape_large' as ImageFormat,
          ...
          },
          {
            ...
            value: {
              format: 'landscape_medium' as ImageFormat,
          ...
          },
          {
            key: 'portrait_small',
            value: {
              format: 'portrait_small' as ImageFormat,
          ...
          },
          {
            key: 'landscape_small',
            value: {
              format: 'landscape_small' as ImageFormat,
          ...
          },
          {
            key: 'portrait_medium',
            value: {
              format: 'portrait_medium' as ImageFormat,
        ...
        hasSvhc: false,
        // Type mismatch between ICustomProduct and Product
        // images: [
        //   {
        //     format: 'landscape_small' as ImageFormat,
  ...
  b2bCustomerData: {
    ...
    functionName: '',
    functionNameEN: '',
    budgetWithoutLimit: false,
    customersBaseSite: '',
    derivedChannel: 'B2C' as Channel,
    legalEmail: '',
    type: '',
    timeout: '',
  },
  ...
  cancellable: true,
  created: new Date('2023-08-18T06:23:58+0000'),
  customerType: 'B2C' as CustomerType,
  guestCustomer: false,
  invoicePaymentModeRequested: false,
  openOrder: false,
  orderDate: new Date('2023-08-18T06:23:58+0000'),
  paymentCost: {
    currencyIso: 'CHF',
    formattedValue: '0,00',
    priceType: 'BUY' as PriceType,
