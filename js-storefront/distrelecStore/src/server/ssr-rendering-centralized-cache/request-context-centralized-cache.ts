...
import { ExpressServerLogger, RequestContext } from '@spartacus/setup/ssr';
import { W3cTraceContext } from './w3c-trace-context/w3c-trace-context.model';
import { parseTraceparent } from './w3c-trace-context/parse-traceparent';
 ...
 */
export const preprocessRequestForLogger = (request: Request, logger: ExpressServerLogger) => {
 ...
 *
 */
const getTraceContext = (request: Request, logger: ExpressServerLogger): W3cTraceContext | undefined => {
  try {
