 ...
 */
package com.namics.distrelec.b2b.backoffice.jalo;
 ...
 */
public class DistrelecB2BbackofficeManager extends GeneratedDistrelecB2BbackofficeManager {
    /**
     * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
     */
    private static final Logger LOG = Logger.getLogger(DistrelecB2BbackofficeManager.class.getName());
     ...
     */
    public static DistrelecB2BbackofficeManager getInstance() {
        return (DistrelecB2BbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
            .getExtension(DistrelecB2BbackofficeConstants.EXTENSIONNAME);
    }
     ...
     */
    public DistrelecB2BbackofficeManager() // NOPMD
    {
        if (LOG.isDebugEnabled()) {
            LOG.debug("constructor of DistrelecB2BbackofficeManager called.");
        }
    }
