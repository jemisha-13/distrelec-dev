...
import de.factfinder.webservice.ws71.FFcampaign.ArrayOfString;
 ...
 */
public class CartCampaignRequestConverter extends AbstractPopulatingConverter<CartCampaignRequest, CampaignResponse> {

    private static final Logger LOG = LoggerFactory.getLogger(CartCampaignRequestConverter.class);
    ...
    @Override
    public void populate(final CartCampaignRequest source, final CampaignResponse target) {
        try {
            ...
            final ArrayOfCampaign campaignResult = port.getShoppingCartCampaigns(source.getChannel(), productCodes, false,
