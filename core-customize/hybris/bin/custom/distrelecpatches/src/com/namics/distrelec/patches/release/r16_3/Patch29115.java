 ...
 */
@Component
public class Patch29115 extends AbstractDemoPatch implements SimpleDemoPatch
{

	public Patch29115()
	{
		super("patch_29115", "patch_29115", R16_3, V0);
	}

	@Override
	public void createGlobalData(final Set<ImportLanguage> languages, final boolean updateLanguagesOnly)
	{
		importGlobalData("rpatch_29115_010-globalDataExample.impex", languages, updateLanguagesOnly);
	}
}
