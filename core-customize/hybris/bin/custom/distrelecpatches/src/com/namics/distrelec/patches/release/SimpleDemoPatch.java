...
/**
 * Patches demo specific interface, which provides default empty implementation for methods declared in {@link DemoPatch} interface. Use in patch
 * classes which do not need to implement all methods required by {@link AbstractDemoPatch}. Example:
 *
 * <pre>
...
public interface SimpleDemoPatch extends DemoPatch {
    ...
    @Override
    default void createShopData(final ShopOrganisation unit, final Set<ImportLanguage> languages, final boolean updateLanguagesOnly) {
        // empty
    }
