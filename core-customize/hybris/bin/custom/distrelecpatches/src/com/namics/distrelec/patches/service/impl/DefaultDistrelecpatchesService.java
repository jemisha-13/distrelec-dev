...
public class DefaultDistrelecpatchesService implements DistrelecpatchesService {
    private static final Logger LOG = LoggerFactory.getLogger(DefaultDistrelecpatchesService.class);
    ...
    public void createLogo(final String logoCode) {
        ...
        final CatalogUnawareMediaModel media = existingLogo.isPresent() ? existingLogo.get() : modelService.create(CatalogUnawareMediaModel.class);
    ...
    private final static String FIND_LOGO_QUERY = "SELECT {" + CatalogUnawareMediaModel.PK + "} FROM {" + CatalogUnawareMediaModel._TYPECODE + "} " +
                                                    "WHERE {" + CatalogUnawareMediaModel.CODE + "}=?code";
    ...
    private InputStream getImageStream() {
        return DefaultDistrelecpatchesService.class.getResourceAsStream("/distrelecpatches/sap-hybris-platform.png");
    }
