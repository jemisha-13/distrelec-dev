 ...
 */
package com.namics.distrelec.b2b.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(DistrelecB2BFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(DistrelecB2BFulfilmentProcessConstants.PARENT_PROCESS);
