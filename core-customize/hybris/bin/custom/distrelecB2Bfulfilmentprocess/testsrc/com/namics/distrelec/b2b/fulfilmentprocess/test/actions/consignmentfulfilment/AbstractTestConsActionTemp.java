...
import com.namics.distrelec.b2b.fulfilmentprocess.test.actions.TestActionTemp;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, DistrelecB2BFulfilmentProcessConstants.PARENT_PROCESS);
