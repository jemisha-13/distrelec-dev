 ...
 */
package com.namics.distrelec.b2b.backofficepermissions.jalo;
...
import com.namics.distrelec.b2b.backofficepermissions.constants.DistrelecB2BbackofficepermissionsConstants;
 ...
 */
public class DistrelecB2BbackofficepermissionsManager extends GeneratedDistrelecB2BbackofficepermissionsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(DistrelecB2BbackofficepermissionsManager.class.getName());
	 ...
	 */
	public static DistrelecB2BbackofficepermissionsManager getInstance()
	{
		return (DistrelecB2BbackofficepermissionsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(DistrelecB2BbackofficepermissionsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DistrelecB2BbackofficepermissionsManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of DistrelecB2BbackofficepermissionsManager called.");
		}
	}
