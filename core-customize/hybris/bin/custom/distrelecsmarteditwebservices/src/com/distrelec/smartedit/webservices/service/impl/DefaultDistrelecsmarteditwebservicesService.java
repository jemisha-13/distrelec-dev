...
public class DefaultDistrelecsmarteditwebservicesService implements DistrelecsmarteditwebservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultDistrelecsmarteditwebservicesService.class);
	...
	{
		return DefaultDistrelecsmarteditwebservicesService.class.getResourceAsStream("/distrelecsmarteditwebservices/sap-hybris-platform.png");
	}
