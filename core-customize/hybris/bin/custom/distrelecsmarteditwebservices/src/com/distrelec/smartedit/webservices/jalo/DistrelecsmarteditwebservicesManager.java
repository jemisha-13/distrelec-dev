 ...
 */
package com.distrelec.smartedit.webservices.jalo;
...
/**
 * This is the extension manager of the Distrelecsmarteditwebservices extension.
 */
public class DistrelecsmarteditwebservicesManager extends GeneratedDistrelecsmarteditwebservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(DistrelecsmarteditwebservicesManager.class);
	 ...
	 */
	public static DistrelecsmarteditwebservicesManager getInstance()
	{
		return (DistrelecsmarteditwebservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(DistrelecsmarteditwebservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public DistrelecsmarteditwebservicesManager() // NOPMD 
	{
		LOG.debug("constructor of DistrelecsmarteditwebservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of DistrelecsmarteditwebservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of DistrelecsmarteditwebservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
