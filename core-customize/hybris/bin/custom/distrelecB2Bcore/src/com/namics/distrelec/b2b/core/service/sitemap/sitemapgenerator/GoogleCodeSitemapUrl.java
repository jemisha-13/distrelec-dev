...
public class GoogleCodeSitemapUrl extends WebSitemapUrl {
    ...
    public enum FileType {
         ...
         */
        ARCHIVE("Archive"), ADA("Ada"), APPLESCRIPT("AppleScript"), ASP("ASP"), ASSEMBLY("Assembly"), AUTOCONF("Autoconf"), AUTOMAKE("Automake"), AWK("Awk"), BASIC(
                "Basic/Visual Basic"), BAT("batch file"), C("C"), CPP("C++"), CSHARP("C#"), COBOL("COBOL"), COLDFUSION("ColdFusion"), CONFIGURE(
                "configure script"), CPUDESCGCC("GCC machine description"), CPUDESCLCC("LCC machine description"), CPUDESCMONO("Mono machine description"), CPUDESCVCODE(
                "VCODE machine description"), CSS("CSS"), CSV("CSV"), D("D"), EIFFEL("Eiffel"), ERLANG("Erlang"), FORTRAN("Fortran"), HASKELL("Haskell"), HTML(
                "HTML"), JAVA("Java"), JAVASCRIPT("JavaScript"), JSP("JSP"), LEX("Lex"), LIMBO("Limbo"), LISP("Lisp"), LUA("Lua"), M4("m4"), MAKEFILE(
                "Makefile"), MATHEMATICA("Mathematica"), MATLAB("Matlab"), MODULA2("Modula-2"), MODULA3("Modula-3"), OBJECTIVEC("Objective C"), OCAML("OCaml"), PASCAL(
                "Pascal/Delphi"), PATCH("diff file"), PERL("Perl"), PHP("PHP"), POD("Plain Old Documentation"), MESSAGECATALOG("message catalog"), POSTSCRIPT(
                "PostScript"), PROLOG("Prolog"), PYTHON("Python"), R("R"), REBOL("REBOL"), RUBY("Ruby"), SCHEME("Scheme"), SHELL("Shell"), SGML("SGML"), SMALLTALK(
                "Smalltalk"), SQL("SQL"), SML("Standard ML"), SVG("SVG"), TCL("Tcl"), TEX("TeX/LaTeX"), TEXINFO("Texinfo"), TROFF("Troff"), VHDL("VHDL"), VIM(
                "Vim script"), XML("XML"), XPM("XPM"), XSLT("XSLT"), XSUB("XSUB"), XUL("XUL"), YACC("Yacc");
     ...
     */
    public enum License {
        ALADDIN("Aladdin Public License"), ARTISTIC("Artistic License"), APACHE("Apache License"), APPLE("Apple Public Source License"), BSD("BSD License"), CPL(
                "Common Public License"), GPL("GNU General Public License"), LGPL("GNU Lesser General Public License"), DISCLAIMER(
                "Historical Permission Notice and Disclaimer"), IBM("IBM Public License"), LUCENT("Lucent Public License"), MIT("MIT License"), MOZILLA(
                "Mozilla Public License"), NASA("NASA Open Source Agreement"), PYTHON("Python Software Foundation License"), QPL("Q Public License"), SLEEPYCAT(
    ...
    public static class Options extends AbstractSitemapUrlOptions<GoogleCodeSitemapUrl, Options> {
        ...
        /**
         * Specifies code license; when the value is not one of the recognized licenses, this will cause Google to index the item as
         * "unknown license".
         */
        ...
        /**
         * The name of the actual file; this is useful if the URL ends in something like download.php?id=1234 instead of the actual
         * filename. The name can contain any character except "/". If the file is an {@link FileType#ARCHIVE} file, it will be indexed only
         * if it has one of the supported archive suffixes.
         * 
        ...
        /**
         * The URL truncated at the top-level directory for the package; this tells Google which files belong together. For use only when
         * the filetype is not {@link FileType#ARCHIVE}. For example, the file http://path/Foo/1.23/bar/file.c could have the package URL
        ...
        /**
         * The name of the packagemap file inside an {@link FileType#ARCHIVE}; just like a Sitemap is a list of files on a web site, a
         * packagemap is a list of files in a package. Case-sensitive. For use only when filetype is {@link FileType#ARCHIVE}.
         */
