...
public class DistBMECatExportCronjob extends GeneratedDistBMECatExportCronjob {

    @SuppressWarnings("unused")
    private final static Logger LOG = Logger.getLogger(DistBMECatExportCronjob.class.getName());
