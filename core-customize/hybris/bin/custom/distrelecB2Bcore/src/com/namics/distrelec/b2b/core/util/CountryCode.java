 ...
 * 
 * <p>
 * Enum names of this enum themselves are represented by <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2">ISO 3166-1 alpha-2</a>
 * codes. There are instance methods to get the country name ({@link #getName()}), the <a
 * href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3" >ISO 3166-1 alpha-3</a> code ({@link #getAlpha3()}) and the <a
 * href="http://en.wikipedia.org/wiki/ISO_3166-1_numeric">ISO 3166-1 numeric</a> code ({@link #getNumeric()}). In addition, there are static
 * methods to get a CountryCode instance that corresponds to a given alpha-2/alpha-3/numeric code ({@link #getByCode(String)},
 * {@link #getByCode(int)}).
 * </p>
 * 
...
public enum CountryCode {
    ...
    /** <a href="https://en.wikipedia.org/wiki/Northern_Ireland">United Kingdom - Northern Ireland</a> */
    XI("United Kingdom - Northern Ireland", "GBR", 826),
    ...
    private CountryCode(final String name, final String alpha3, final int numeric) {
        this.name = name;
        this.alpha3 = alpha3;
    ...
    public static CountryCode getByCode(final int code) {
        return numericMap.get(Integer.valueOf(code));
    }
}
