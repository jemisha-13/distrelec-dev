...
public class DistOracleTasksQueueGateway extends OracleTasksQueueGateway {

    private final SchedulerRoleQueries schedulerRoleQueries;

    public DistOracleTasksQueueGateway(JdbcTemplate jdbcTemplate, TypeService typeService,
