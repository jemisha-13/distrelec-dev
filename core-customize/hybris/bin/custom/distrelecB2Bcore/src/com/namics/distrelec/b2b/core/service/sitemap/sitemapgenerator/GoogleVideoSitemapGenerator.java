...
public class GoogleVideoSitemapGenerator extends SitemapGenerator<GoogleVideoSitemapUrl, GoogleVideoSitemapGenerator> {
     ...
     */
    public static SitemapGeneratorBuilder<GoogleVideoSitemapGenerator> builder(final URL baseUrl, final File baseDir) {
     ...
     * @return a builder; call .build() on it to make a sitemap generator
     */
    public static SitemapGeneratorBuilder<GoogleVideoSitemapGenerator> builder(final String baseUrl, final File baseDir) throws MalformedURLException {
        return new SitemapGeneratorBuilder<GoogleVideoSitemapGenerator>(baseUrl, baseDir, GoogleVideoSitemapGenerator.class);
    }

    GoogleVideoSitemapGenerator(final AbstractSitemapGeneratorOptions<?> options) {
     ...
     */
    public GoogleVideoSitemapGenerator(final String baseUrl, final File baseDir) throws MalformedURLException {
     ...
     *            Sitemap files will be generated in this directory as either "sitemap.xml" or "sitemap1.xml" "sitemap2.xml" and so on.
     */
    public GoogleVideoSitemapGenerator(final URL baseUrl, final File baseDir) {
        this(new SitemapGeneratorOptions(baseUrl, baseDir));
    }

    private static class Renderer extends AbstractSitemapUrlRenderer<GoogleVideoSitemapUrl> {
        ...
        @Override
        public void render(final GoogleVideoSitemapUrl url, final OutputStreamWriter out, final W3CDateFormat dateFormat) throws IOException {
