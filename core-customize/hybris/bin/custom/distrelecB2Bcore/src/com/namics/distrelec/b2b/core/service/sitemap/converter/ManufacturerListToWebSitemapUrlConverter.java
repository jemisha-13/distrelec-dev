 ...
 * 
 */
public class ManufacturerListToWebSitemapUrlConverter implements WebSitemapUrlConverter<List<String>> {
    private static final Logger LOG = Logger.getLogger(ManufacturerListToWebSitemapUrlConverter.class);
