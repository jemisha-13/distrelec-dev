...
/**
 * One configurable Geo URL, either KML or GeoRSS. At this time, SitemapGen4j can't generate either KML or GeoRSS (sorry). To configure this
 * class, use {@link Options}
 * 
 * @author Dan Fabulich
 * @see Options
