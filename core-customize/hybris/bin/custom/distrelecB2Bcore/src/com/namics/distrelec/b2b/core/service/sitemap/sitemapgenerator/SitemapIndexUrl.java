...
public class SitemapIndexUrl {
    ...
    /**
     * Configures the sitemap URL with no specified lastMod; we'll use {@link SitemapIndexGenerator.Options#defaultLastMod(Date)} or leave
     * it blank if no default is specified
     */
