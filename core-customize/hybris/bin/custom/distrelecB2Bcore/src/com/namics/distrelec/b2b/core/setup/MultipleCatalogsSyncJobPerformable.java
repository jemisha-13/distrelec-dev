...
public class MultipleCatalogsSyncJobPerformable extends AbstractJobPerformable<MultipleCatalogsSyncCronJobModel> {
    ...
    public PerformResult perform(final MultipleCatalogsSyncCronJobModel cronJob) {
        ...
        Preconditions.checkArgument(!CollectionUtils.isEmpty(cronJob.getContentCatalogs()), "Given cron job's content catalog should not be empty");
    ...
    private PerformResult callInternal(final List<String> allCatalogs) {
