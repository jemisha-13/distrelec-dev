...
public class SitemapIndexGenerator {
    ...
    public static class Options {
        ...
        /**
         * The maximum number of sitemaps to allow per sitemap index; the default is the maximum allowed (1,000), but you can decrease it if
        ...
        /**
         * The default lastMod date for sitemap indexes; the default default is now, but you can pass in null to omit a lastMod entirely. We
         * don't recommend this; Google may not like you as much.
         */
    ...
    public SitemapIndexGenerator addUrls(final List<File> writtenFiles) {
        for (final File file : writtenFiles) {

            try {
                addUrl(new URL(baseUrl, file.getName()));
            } catch (MalformedURLException e) {
                throw new RuntimeException(e);
            }
        }
