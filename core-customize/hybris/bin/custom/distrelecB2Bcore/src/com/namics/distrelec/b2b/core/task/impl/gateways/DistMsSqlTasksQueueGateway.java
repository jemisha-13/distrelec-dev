...
public class DistMsSqlTasksQueueGateway extends MsSqlTasksQueueGateway {

    private final SchedulerRoleQueries schedulerRoleQueries;

    public DistMsSqlTasksQueueGateway(JdbcTemplate jdbcTemplate, TypeService typeService,
