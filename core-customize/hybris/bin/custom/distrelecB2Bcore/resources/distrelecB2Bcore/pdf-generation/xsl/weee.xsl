                        ...
                        <fo:table table-layout="fixed">
                            ...
                            <fo:table-body>
                                ...
                                <fo:table-row height="12.0pt">
                                    <fo:table-cell>
                                        <fo:block>
                                            <xsl:apply-templates select="PARAGRAPH1LINE1" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row height="10.0pt">
                        ...
                        <fo:block-container>
                                <fo:block margin-bottom="10pt" margin-left="40pt">
                                    <fo:block margin-bottom="5pt">
                                        ...
                                        <fo:inline>
                                            <xsl:apply-templates select="PARAGRAPH3LINE1"/>
                                        </fo:inline>
                                    </fo:block>
                                    ...
                                    <fo:block margin-bottom="5pt">
                                        ...
                                        <fo:inline>
                                            <xsl:apply-templates select="PARAGRAPH3LINE2"/>
                                        </fo:inline>
                                    </fo:block>
                                    ...
                                    <fo:block margin-bottom="5pt">
                                        ...
                                        <fo:inline>
                                            <xsl:apply-templates select="PARAGRAPH3LINE3"/>
                                        </fo:inline>
                                    </fo:block>
                                </fo:block>
                        </fo:block-container>
