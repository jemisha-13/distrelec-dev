...
<xsl:stylesheet
    ...
    <xsl:template match="DISPOSAL_OF_PACKAGING">
                        ...
                        <fo:table table-layout="fixed">
                            ...
                            <fo:table-body>
                                    ...
                                    <fo:table-cell>
                                        <fo:block text-align="left">
                                            <fo:external-graphic content-width="90pt" content-height="120">
                                                <xsl:attribute name="src">url('<xsl:apply-templates select="RECYCLING_SYMBOL"/>') />
                                                </xsl:attribute>
                                            </fo:external-graphic>
                                            <fo:external-graphic content-width="90pt" content-height="120">
                                                <xsl:attribute name="src">url('<xsl:apply-templates select="HDPE_RECYCLING_SYMBOL"/>') />
                                                </xsl:attribute>
                                            </fo:external-graphic>
                                        </fo:block>
                                    </fo:table-cell>
                                ...
                                <fo:table-row height="12.0pt">
                                    <fo:table-cell>
                                        <fo:block>
                                            <xsl:apply-templates select="PARAGRAPH7" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row height="10.0pt">
                                ...
                                <fo:table-row height="12.0pt">
                                    <fo:table-cell>
                                        <fo:block>
                                            <xsl:apply-templates select="PARAGRAPH8" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row height="30.0pt">
                                ...
                                <fo:table-row height="12.0pt">
                                    <fo:table-cell>
                                        <fo:block text-align="center" font-weight="bold">
                                            <xsl:apply-templates select="PARAGRAPH9" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row height="10.0pt">
