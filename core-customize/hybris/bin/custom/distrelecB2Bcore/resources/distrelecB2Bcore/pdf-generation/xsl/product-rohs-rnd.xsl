...
<xsl:stylesheet
    ...
    <xsl:template match="PRODUCT-ROHS-RND">
            ...
            <fo:page-sequence master-name="masterNamePageMain0"
                ...
                <fo:static-content flow-name="regionBefore1">
                    <fo:block-container font-family="OpenSans">
                                ...
                                <fo:table-body>
                                    <fo:table-row>
                                        <fo:table-cell>
                                            ...
                                            <fo:block color="#808080" margin-top="3pt" font-size="25" font-weight="bold">
                        ...
                        <fo:block color="#808080" font-size="17" font-weight="bold">
                    ...
                    <fo:block-container font-family="OpenSans" font-size="11pt" line-height="1.3" margin-top="25pt">
                        ...
                        <fo:block margin-bottom="10pt" margin-left="40pt">
                            <fo:block>
                                ...
                                <fo:inline>
                                    <xsl:apply-templates select="BULLETPOINT1"/>
                                </fo:inline>
                            </fo:block>
                            ...
                            <fo:block>
                                ...
                                <fo:inline>
                                    <xsl:apply-templates select="BULLETPOINT2"/>
                                </fo:inline>
                            </fo:block>
                            ...
                            <fo:block>
                                ...
                                <fo:inline>
                                    <xsl:apply-templates select="BULLETPOINT3"/>
                                </fo:inline>
                            </fo:block>
                            ...
                            <fo:block>
                                ...
                                <fo:inline>
                                    <xsl:apply-templates select="BULLETPOINT4"/>
                                </fo:inline>
                            </fo:block>
                            ...
                            <fo:block>
                                ...
                                <fo:inline>
                                    <xsl:apply-templates select="BULLETPOINT5"/>
                                </fo:inline>
                            </fo:block>
                            ...
                            <fo:block>
                                ...
                                <fo:inline>
                                    <xsl:apply-templates select="BULLETPOINT6"/>
                                </fo:inline>
                            </fo:block>
                            ...
                            <fo:block>
                                ...
                                <fo:inline>
                                    <xsl:apply-templates select="BULLETPOINT7"/>
                                </fo:inline>
                            </fo:block>
                            ...
                            <fo:block>
                                ...
                                <fo:inline>
                                    <xsl:apply-templates select="BULLETPOINT8"/>
                                </fo:inline>
                            </fo:block>
                            ...
                            <fo:block>
                                ...
                                <fo:inline>
                                    <xsl:apply-templates select="BULLETPOINT9"/>
                                </fo:inline>
                            </fo:block>
                            ...
                            <fo:block>
                                ...
                                <fo:inline>
                                    <xsl:apply-templates select="BULLETPOINT10"/>
                                </fo:inline>
                            </fo:block>
                        </fo:block>
                    ...
                    <fo:block-container font-family="OpenSans" font-size="11pt">
                        <fo:block margin-top="25pt" margin-right="5%">
