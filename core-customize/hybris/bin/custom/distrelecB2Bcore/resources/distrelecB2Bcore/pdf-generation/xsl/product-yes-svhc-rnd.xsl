                ...
                <fo:static-content flow-name="regionBefore1">
                    ...
                    <fo:block-container font-family="OpenSans" font-size="11pt" line-height="1.3" margin-top="25pt">
                        ...
                        <fo:block margin-bottom="30pt">
                            ...
                            <fo:block margin-bottom="10pt" font-weight="bold">
                                <xsl:apply-templates select="YESSVHC_PARAGRAPH"/>
                            </fo:block>

                            <xsl:if test="SVHCNAMED_PARAGRAPH != ''">
                                <fo:block margin-bottom="5pt" font-weight="bold">
                                    <xsl:apply-templates select="SVHCNAMED_TITLE"/>
                                </fo:block>

                                <fo:block margin-bottom="10pt">
                                    <xsl:apply-templates select="SVHCNAMED_PARAGRAPH"/>
                                </fo:block>
                            </xsl:if>

                            <xsl:if test="SCIP_PARAGRAPH != ''">
                                <fo:block margin-bottom="5pt" font-weight="bold">
                                    <xsl:apply-templates select="SCIP_TITLE"/>
                                </fo:block>

                                <fo:block margin-bottom="10pt">
                                    <xsl:apply-templates select="SCIP_PARAGRAPH"/>
                                </fo:block>
                            </xsl:if>
