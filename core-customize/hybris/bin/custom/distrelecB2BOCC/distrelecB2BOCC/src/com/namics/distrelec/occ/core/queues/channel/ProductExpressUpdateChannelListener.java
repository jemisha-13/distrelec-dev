 ...
 */
package com.namics.distrelec.occ.core.queues.channel;

import com.google.common.base.Predicate;
import com.namics.distrelec.occ.core.queues.UpdateQueue;
import com.namics.distrelec.occ.core.queues.data.ProductExpressUpdateElementData;
import com.namics.distrelec.occ.core.queues.util.ProductExpressUpdateElementPredicate;
...
public class ProductExpressUpdateChannelListener {
    ...
    public void onMessage(final ProductModel product) {
        ...
        final ProductExpressUpdateElementData productExpressUpdateElementData = getProductExpressUpdateElementConverter().convert(product);
    ...
    /**
     * Method return object which will be used to determine if element is equal to productExpressUpdateElementData parameter.
     *
     ...
     */
    protected Predicate<ProductExpressUpdateElementData> getPredicate(final ProductExpressUpdateElementData productExpressUpdateElementData) {
    ...
    @Required
    public void setProductExpressUpdateElementConverter(final Converter<ProductModel, ProductExpressUpdateElementData> productExpressUpdateElementConverter) {
