...
import com.namics.distrelec.occ.core.validation.data.CartVoucherValidationData;
...
public class CartVoucherValidationErrorConverterTest {
    ...
    public void setUp() {
        ...
        given(messageSource.getMessage(eq(APPLIED_VOUCHER_EXPIRED), any(Object[].class), anyString(), nullable(Locale.class))).willReturn(APPLIED_VOUCHER_EXPIRED);
    }
