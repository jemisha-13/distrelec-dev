...
public class ConsentFilterTest {
    ...
    public void setUp() {
        ...
        doAnswer(delegatesTo((AnonymousConsentFacade) (in, out) -> out.accept(in.get()))) //
                                                                                         .when(anonymousConsentFacade)
                                                                                         .synchronizeAnonymousConsents(any(), any());
    ...
    protected AnonymousConsentData createAnonymousConsent(final String templateCode, final int templateVersion, final String consentState) {
