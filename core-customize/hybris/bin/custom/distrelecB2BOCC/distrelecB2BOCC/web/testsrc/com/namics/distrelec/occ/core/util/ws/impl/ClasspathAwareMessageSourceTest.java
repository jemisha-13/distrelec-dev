...
import static com.namics.distrelec.occ.core.util.ws.impl.ClasspathAwareMessageSource.classpathResourceMapper;
...
public class ClasspathAwareMessageSourceTest {
    ...
    public void mapToMessageBundlePath() {
        assertEquals(RELATIVE_PATH_TO_PROPERTIES_BUNDLE, classpathAwareMessageSource.mapToMessageBundlePath(relativePathToPropertiesFile));
    }
