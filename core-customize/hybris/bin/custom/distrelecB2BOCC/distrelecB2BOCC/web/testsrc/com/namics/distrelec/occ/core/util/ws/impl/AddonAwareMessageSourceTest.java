...
public class AddonAwareMessageSourceTest {
    private static final String ADDON_PATH = "/Users/Develop/yenv/dev/sources/commercewebservices/distrelecB2BOCC/web/webroot/WEB-INF/messages/addons/webserviceaddon";
    ...
    public void formatPathTest() {
        final String formattedPath = addonAwareMessageSource.formatPath(input, "/WEB-INF/messages/addons/".replace("/", File.separator));
