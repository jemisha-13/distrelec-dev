...
import com.namics.distrelec.occ.core.validation.data.CartVoucherValidationDataList;
...
/**
 * Converts {@link CartVoucherValidationDataList} to a list of {@link de.hybris.platform.webservicescommons.dto.error.ErrorWsDTO}.
 */
public class CartVoucherValidationListErrorConverter extends AbstractErrorConverter {
    ...
    public void populate(final Object o, final List<ErrorWsDTO> webserviceErrorList) {
        ...
        webserviceErrorList.addAll(getCartVoucherValidationErrorConverter().convertAll(cartVoucherValidationDataList.getCartVoucherValidationDataList()));
    }
