...
/**
 * Converts {@link CartModificationData} to a list of {@link de.hybris.platform.webservicescommons.dto.error.ErrorWsDTO}.
 */
public class CartModificationDataErrorConverter extends AbstractLocalizedErrorConverter {
    ...
    /**
     * @deprecated since 2011. Please use {@link CartModificationDataErrorConverter#MSG_KEY_PREFIX} followed by reason, for example:
     *             {@link CommerceCartModificationStatus#NO_STOCK}
     */
    @Deprecated(since = "2011", forRemoval = true)
    ...
    /**
     * @deprecated since 2011. Please use {@link CartModificationDataErrorConverter#MSG_KEY_PREFIX} followed by reason, for example:
     *             {@link CommerceCartModificationStatus#LOW_STOCK}
     */
    @Deprecated(since = "2011", forRemoval = true)
    ...
    protected String getNoStockMessage(final CartModificationData cartModification, final Locale locale) {
        final Object[] args = new Object[] { cartModification.getEntry().getProduct().getCode(), cartModification.getEntry().getEntryNumber() };
