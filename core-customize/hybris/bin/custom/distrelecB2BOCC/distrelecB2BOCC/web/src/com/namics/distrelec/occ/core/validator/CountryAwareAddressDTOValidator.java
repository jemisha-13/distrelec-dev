 ...
 * {@link #countrySpecificAddressWsDTOValidators}. {@code AddressValidator} uses the country.isocode field to select a suitable validator
 * for a specific country. If a matching validator cannot be found, {@link #commonAddressWsDTOValidator} is used.
 */
public class CountryAwareAddressDTOValidator implements Validator {
    ...
    public void validate(final Object target, final Errors errors) {
        ...
        if (address == null || address.getCountry() == null || address.getCountry().getIsocode() == null
            ...
            errors.rejectValue(COUNTRY_ISO, FIELD_REQUIRED_AND_NOT_TOO_LONG_MESSAGE_ID, new String[] { String.valueOf(MAX_ISOCODE_LENGTH) }, null);
