...
import com.namics.distrelec.occ.core.exceptions.BaseSiteMismatchException;
...
/**
 * BaseSiteCheckFilter is responsible for checking if base site set in current session cart is the same as one set in baseSiteService It
 * prevents mixing requests for multiple sites in one session
 */
