...
import com.namics.distrelec.occ.core.product.data.PromotionDataList;
...
public class PromotionsController extends BaseController {
    ...
    @Operation(operationId = "getPromotions", summary = "Get a list of promotions.", description = "Returns promotions defined for a current base site. Requests pertaining to promotions have been developed "
    ...
    public PromotionListWsDTO getPromotions(
                                            @Parameter(description = "Defines what type of promotions should be returned. Values supported for that parameter are: <ul><li>all: All available promotions are "
                                                                     + "returned</li><li>product: Only product promotions are returned</li><li>order: Only order promotions are returned</li></ul>", schema = @Schema(allowableValues = { "all",
                                                                                                                                                                                                                                          "product",
                                                                                                                                                                                                                                          "order" }), required = true) @RequestParam final String type,
    ...
    @ResponseBody
    @Operation(operationId = "getPromotion", summary = "Get a promotion based on code", description = "Returns details of a single promotion specified by a promotion code. Requests pertaining to "
    ...
    @ApiBaseSiteIdParam
    public PromotionWsDTO getPromotion(@Parameter(description = "Promotion identifier (code)", required = true) @PathVariable final String code,
                                       @ApiFieldsParam(defaultValue = BASIC_FIELD_SET) @RequestParam(defaultValue = BASIC_FIELD_SET) final String fields) {
