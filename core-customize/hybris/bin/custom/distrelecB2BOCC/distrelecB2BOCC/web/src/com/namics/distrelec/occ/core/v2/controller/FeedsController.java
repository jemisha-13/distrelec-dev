...
import com.namics.distrelec.occ.core.queues.data.OrderStatusUpdateElementDataList;
...
public class FeedsController extends BaseController {
    ...
    @ResponseBody
    @Operation(operationId = "getOrderStatusFeed", summary = "Get a list of orders with status updates.", description = "Returns the orders that have changed status. Returns only the elements from the "
