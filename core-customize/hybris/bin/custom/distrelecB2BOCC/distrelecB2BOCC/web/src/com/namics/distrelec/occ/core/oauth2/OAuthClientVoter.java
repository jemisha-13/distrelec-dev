 ...
 * <p>
 * Only config attributes starting with 'prefix' will be took into consideration. Default prefix is 'CLIENT_'. Prefix can be customized, in
 * particular when null all config attributes will be analyzed.
 * <p>
