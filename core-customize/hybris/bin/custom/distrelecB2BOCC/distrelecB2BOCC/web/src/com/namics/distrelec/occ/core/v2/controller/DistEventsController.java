...
import com.namics.distrelec.occ.core.eventtracking.RawEventEnricher;
...
@RequestMapping(value = "/{baseSiteId}/events")
@CommonQueryParams
public class DistEventsController {

    private static final Logger LOG = Logger.getLogger(DistEventsController.class);
    ...
    public DistEventsController(final QueueChannel rawTrackingEventsChannel, final RawEventEnricher rawEventEnricher) {
