 ...
 */
package com.namics.distrelec.occ.core.populator;

import com.namics.distrelec.occ.core.populator.options.PaymentInfoOption;
 ...
 * </ul>
 * <p>
 * If populator's options contains {@link PaymentInfoOption#BILLING_ADDRESS}, it uses {@link HttpRequestAddressDataPopulator} with prefix
 * 'billingAddress' to populate also the billing address data from http request request parameters.
 */
...
public class HttpRequestPaymentInfoPopulator extends AbstractHttpRequestDataPopulator
    ...
    @Override
    public void populate(final HttpServletRequest request, final CCPaymentInfoData target, final Collection<PaymentInfoOption> options)
