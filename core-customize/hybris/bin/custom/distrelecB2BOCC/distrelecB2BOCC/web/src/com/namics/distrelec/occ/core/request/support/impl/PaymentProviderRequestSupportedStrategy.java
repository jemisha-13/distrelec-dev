 ...
 */
package com.namics.distrelec.occ.core.request.support.impl;

import com.namics.distrelec.occ.core.exceptions.UnsupportedRequestException;
import com.namics.distrelec.occ.core.request.support.RequestSupportedStrategy;
...
/**
 * Implementation for {@link RequestSupportedStrategy} which checks if request is supported based on payment provider name
 */
