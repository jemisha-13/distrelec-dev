...
public class SaveCartController extends BaseCommerceController {
    ...
    @ResponseBody
    @Operation(operationId = "doUpdateFlagForDeletion", summary = "Flag a cart for deletion.", description = "Flags a cart for deletion (the cart doesn't have corresponding save cart attributes anymore). The cart is not "
