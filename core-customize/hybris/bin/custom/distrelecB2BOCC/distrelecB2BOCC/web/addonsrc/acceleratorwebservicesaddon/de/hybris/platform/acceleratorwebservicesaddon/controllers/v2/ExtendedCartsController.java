...
public class ExtendedCartsController
{
	...
	@ResponseBody
	@Operation(operationId = "getConsolidatedPickupLocations", summary = "Get consolidated pickup options.", description =
	...
	@ResponseBody
	@Operation(operationId = "createConsolidatedPickupLocation", summary = "Handles the consolidating pickup locations.", description =
	...
	public CartModificationListWsDTO createConsolidatedPickupLocation(
			@Parameter(description = "The name of the store where items will be picked up", required = true) @RequestParam final String storeName,
	...
	@Operation(operationId = "getSopPaymentRequestDetails", summary = "Get information needed for create subscription", description =
	...
	public PaymentRequestWsDTO getSopPaymentRequestDetails(@Parameter(description =
			...
			@Parameter(description = "Define which url should be returned") @RequestParam(defaultValue = "false") final boolean extendedMerchantCallback,
	...
	@ResponseBody
	@Secured({ "ROLE_CUSTOMERGROUP", "ROLE_GUEST", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT" })
	@Operation(operationId = "doHandleSopPaymentResponse", summary = "Handles response from payment provider and create payment details", description =
	...
	@ApiBaseSiteIdUserIdAndCartIdParam
	public PaymentDetailsWsDTO doHandleSopPaymentResponse(@Parameter(hidden = true) final HttpServletRequest request,
			@Parameter(hidden = true) final SopPaymentDetailsWsDTO sopPaymentDetails,
			@ApiFieldsParam @RequestParam(defaultValue = DEFAULT_LEVEL) final String fields)
	{
	...
	@ResponseBody
	@Secured({ "ROLE_CUSTOMERGROUP", "ROLE_GUEST", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT" })
	@Operation(operationId = "getSopPaymentResponse", summary = "Get information about create subscription request results", description =
	...
	@ResponseBody
	@Secured({ "ROLE_CUSTOMERGROUP", "ROLE_GUEST", "ROLE_CUSTOMERMANAGERGROUP", "ROLE_TRUSTED_CLIENT" })
	@Operation(operationId = "removeSopPaymentResponse", summary = "Deletes payment provider response related to cart.", description = "Deletes the payment provider response related to the specified cart.")
	@ApiBaseSiteIdUserIdAndCartIdParam
