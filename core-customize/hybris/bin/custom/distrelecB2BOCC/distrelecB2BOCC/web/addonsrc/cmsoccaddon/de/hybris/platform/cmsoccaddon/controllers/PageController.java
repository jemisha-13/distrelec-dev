...
public class PageController {
    ...
    public PageAdapterUtil.PageAdaptedData getPage(
                                                   ...
                                                   @Parameter(description = "If pageType is CategoryPage, code should be category code; if pageType is CatalogPage, code should be catalog code") //
                                                   @RequestParam(required = false) final String code,
                                                   @Parameter(description = "If pageType is ProductPage, code should be product code") //
                                                   @RequestParam(required = false) final String productCode,
                                                   @RequestParam(required = false) final String categoryCode,
                                                   @RequestParam(required = false) final String manufacturerCode,
        ...
        try {
            final AbstractPageData pageData = getPageFacade().getPageData(pageType, pageLabelOrId, code != null ? code : productCode);
