 ...
 */
package com.namics.distrelec.occ.test.test.groovy.webservicetests.config
...
public class ModuleConstants {
    ...
    //original name of the web services module, it is not touched by modulegen because we are in distrelecB2BOCCtest
    ...
    public static final String CURRENT_TEST_EXTENSION_NAME = 'distrelecB2BOCCtest';
