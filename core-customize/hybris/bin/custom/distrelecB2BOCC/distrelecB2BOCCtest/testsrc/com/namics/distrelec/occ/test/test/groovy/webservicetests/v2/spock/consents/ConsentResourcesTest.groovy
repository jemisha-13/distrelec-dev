 ...
 */
package com.namics.distrelec.occ.test.test.groovy.webservicetests.v2.spock.consents
...
class ConsentResourcesTest extends AbstractUserTest {
    ...
    def "Fetch the consent template for login user who has give some consents: #format"() {
        ...
        with(response) {
            ...
            isEmpty(data.consentTemplates[0].currentConsent.consentWithdrawnDate)
// make sure the consent wasn't withdrawn
