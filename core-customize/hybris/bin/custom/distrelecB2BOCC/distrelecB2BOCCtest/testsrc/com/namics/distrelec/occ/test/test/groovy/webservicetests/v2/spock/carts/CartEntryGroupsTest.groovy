...
import static com.namics.distrelec.occ.test.setup.TestSetupUtils.anyExtensionPresent
...
class CartEntryGroupsTest extends AbstractCartTest {
     ...
     */
    @IgnoreIf({ anyExtensionPresent("distrelecB2BOCCtest.bundle.extensions") })
