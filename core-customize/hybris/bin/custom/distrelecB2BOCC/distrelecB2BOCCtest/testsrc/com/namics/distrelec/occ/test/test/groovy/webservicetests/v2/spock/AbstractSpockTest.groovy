...
import com.namics.distrelec.occ.test.test.groovy.webservicetests.SSLIssuesIgnoringHttpClientFactory
...
abstract class AbstractSpockTest extends JUnitPlatformSpecification {
    private static String LOG4J_PROPERTIES_CLASS_PATH = "distrelecB2BOCCtest/log4j.properties";
    ...
    protected static ConfigObject config = TestConfigFactory.createConfig("v2", "/distrelecB2BOCCtest/groovytests-property-file.groovy");
    ...
    protected static final String getBasePathWithIntegrationSite() {
        def enableWsIntegrationTest = Config.getBoolean("distrelecB2BOCCtest.enableWsIntegrationTest", false);
