...
class TestUtilCustomDelegatingMetaClass extends DelegatingMetaClass {
    ...
    private Object logGetSecureURLConnection(Object object, String methodName, Object[] arguments) {
        String path, method;
        path = arguments[0];
        method = arguments[1];
    ...
    private Object logMethodGetSecureConnection(Object object, String methodName, Object[] arguments) {
    ...
    private Object logMethodGetConnection(Object object, String methodName, Object[] arguments) {
        String path, method, accept;
        path = arguments[0];
        if (arguments.size() >= 2)
            method = arguments?.getAt(1);
    ...
    private Object logMethodVerifiedXMLSlurper(Object object, String methodName, Object[] arguments) {
    ...
    private Object logMethodVerifiedJSONSlurper(Object object, String methodName, Object[] arguments) {
        Object ret = super.invokeStaticMethod(object, methodName, arguments);
