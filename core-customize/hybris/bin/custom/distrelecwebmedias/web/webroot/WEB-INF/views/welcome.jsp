...
<html lang="en">
<head>
    <title>Welcome to distrelecwebmedias</title>
    <link rel="stylesheet" href="<c:url value="/static/distrelecwebmedias-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "distrelecwebmedias" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><strong>resources/distrelecwebmedias-items.xml</strong> - here you can model your items</li>
            <li><strong>resources/distrelecwebmedias-spring.xml</strong> - here you can define your services</li>
            <li><strong>web/webroot/WEB-INF/config/distrelecwebmedias-spring-mvc-config.xml</strong> - here is a Spring MVC related
                configuration
            </li>
            <li><strong>web/webroot/WEB-INF/config/distrelecwebmedias-web-app-config.xml</strong> - here you can define web related services,
                facades etc.
            </li>
            <li><strong>web/webroot/WEB-INF/config/distrelecwebmedias-spring-security-config.xml</strong> - here you can configure your Spring Security settings</li>
