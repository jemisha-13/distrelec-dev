...
public class DefaultDistrelecB2BjmsService implements DistrelecB2BjmsService {
    private static final Logger LOG = LoggerFactory.getLogger(DefaultDistrelecB2BjmsService.class);

    private final static String FIND_LOGO_QUERY = "SELECT {" + CatalogUnawareMediaModel.PK + "} FROM {" + CatalogUnawareMediaModel._TYPECODE + "} WHERE {"
            + CatalogUnawareMediaModel.CODE + "}=?code";
    ...
    private InputStream getImageStream() {
        return DefaultDistrelecB2BjmsService.class.getResourceAsStream("/distrelecB2Bjms/sap-hybris-platform.png");
    }
