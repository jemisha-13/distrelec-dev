...
class DisthazardSuppInfoCacheKey implements CacheKey {

    private final String tenantId;
    private final String langIsocode;

    public DisthazardSuppInfoCacheKey(final Tenant tenant, final LanguageModel language) {
    ...
    public boolean equals(final Object o) {
        ...
        final DisthazardSuppInfoCacheKey that = (DisthazardSuppInfoCacheKey) o;
