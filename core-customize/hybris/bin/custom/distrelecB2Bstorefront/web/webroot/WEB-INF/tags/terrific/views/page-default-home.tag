...
<views:document-default pageTitle="${pageTitle}" bodyCSSClass="${bodyCSSClass}">
	...
	<%-- DISTRELEC-13259: Organisational Schema --%>
	<mod:schema template="organisation" />

	<%-- DISTRELEC-13257: Sitelink Search Schema --%>
	<mod:schema template="sitelink-search" />
	...
	<div class="md-system locale__${currentCountry.isocode}__${currentLanguage.isocode}">
		<jsp:doBody />
	</div>
