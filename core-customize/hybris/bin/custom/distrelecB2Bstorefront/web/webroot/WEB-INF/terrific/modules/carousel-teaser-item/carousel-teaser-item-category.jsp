...
<spring:message code="category.carousel-teaser.image.missing" text="Image not found" var="sImageMissing"/>
    ...
    <div class="thumb-row">
        <div class="thumb">
            ...
            <picture>
                ...
                <img width="300" height="400" alt="${itemData.image.altText == null ? sImageMissing : itemData.image.altText}" src="${portraitMediumJpg}"/>
            </picture>
            <i></i>
        </div>
    </div>
