		...
		<div class="prod">
			...
			<div class="prod_review">
				...
				<p class="prod_review-info">
					<c:if test="${not empty product.reviews}">
						<a href="${productUrl}?tab=readreviews"><spring:theme code="review.based.on" arguments="${fn:length(product.reviews)}"/></a>
					</c:if>
				</p>
				<p class="prod_review-new">
					<a href="${productUrl}?tab=writereview"><spring:theme code="review.write.title" /></a>
				</p>
			</div>
