	...
	<div class="row">
		<c:choose>
			<c:when test="${fn:length(billingAddressList) gt 1}">
				...
				<div class="col-11 col-md-7 box-address__preview">
				...
				<c:if test="${address.id ne selectedAddressId}">
					<div class="col-12 col-md-4 box-address__btn">
						<a href="#" class="default-link" data-action="/checkout/detail/billing?billingAddressId=${address.id}">
								${sSetDefault}
						</a>
					</div>
				</c:if>
