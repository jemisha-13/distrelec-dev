...
<spring:theme code="checkout.checkout" text="Proceed to checkout" var="sProceedCheckout"/>
...
<input type="hidden" id="hidden-pos" name="pos" value="${pos}"/>
<input type="hidden" id="hidden-origPosition" name="origPos" value="${origPos}"/>
<input type="hidden" id="hidden-origPageSize" name="origPageSize" value="${origPageSize}"/>
<input type="hidden" id="hidden-searchQuery" name="trackQuery" value="${trackQuery}"/>
<input type="hidden" id="hiddenPageType" name="pageType" value="productPageType"/>
<input type="hidden" id="hidden-filterapplied" name="filterapplied" value="${filterapplied}"/>
    ...
    <div class="elem__content elem__content--first">
		...
		<div class="numeric" data-product-code="${product.code}"
			...
			<div class="btn-wrapper">
				<button class="btn numeric-btn numeric-btn-down">&ndash;</button>
			...
			<c:otherwise>
				<c:choose>
					...
					<c:otherwise>
						...
						<button class="mat-button mat-button--action-green btn-cart fb-add-to-cart disabled" disabled="disabled" data-product-code="${product.code}" title="<spring:message code='buyingSection.add.to.cart'/>">
						...
						<a href="/cart/checkout" class="btn-added-to-cart fb-order-purchase" data-aainteraction="proceed to checkout">
							<span class="ellipsis btn-added-to-cart--checkout" title="${sProceedCheckout}">
								${sProceedCheckout} <i class="fas fa-angle-right"></i>
							</span>
						</a>
