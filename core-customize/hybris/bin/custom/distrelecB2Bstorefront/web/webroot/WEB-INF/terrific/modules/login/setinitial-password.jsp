...
<c:url value="/account/password/setinitialpw" var="action" />

<div class="form-box border-top border-bottom base padding-gu">

	<p class="padding small">${sIntro}</p>

	<form:form method="post" action="${action}" modelAttribute="setInitialPwdForm">
		<div class="row">
			...
			<div class="gu-8 pwi-trigger" data-pwi-content="${sPasswordStrengthContent}" data-pwi-title="${sPasswordStrengthTitle}" data-pwi-target="pwi-target" data-pwi-input="pwi-field">
				<formUtil:formPasswordBox idKey="updatePwd-pwd" path="pwd" placeHolderKey="updatePwd.pwd.placeholder" inputCSS="field password strength pwi-field" mandatory="true" tabindex="1"/>
			</div>
		...
		<div class="row">
			...
			<div class="gu-8">
				<formUtil:formPasswordBox idKey="updatePwd.checkPwd"  path="checkPwd" placeHolderKey="updatePwd.checkPwd.placeholder" inputCSS="text password" mandatory="true" tabindex="2" errorPath="setInitialPwdForm"/>
			</div>
		</div>
		<div class="row">
