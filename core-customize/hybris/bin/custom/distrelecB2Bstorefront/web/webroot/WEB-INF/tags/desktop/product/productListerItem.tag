...
<div class="prod_list">
	<ycommerce:testId code="test_searchPage_wholeProduct">
		...
		<div class="details">
			...
			<p>
				<spring:theme code="text.availability" text="Number of available products: "/> ${product.summary}
			</p>
		...
		<div class="cart">
			...
			<c:if test="${product.volumePricesFlag}">
				<span class="volumePricesFlag"><theme:image code="img.volumePrices" alt="text.volumePrices" title="text.volumePrices" /></span>
			</c:if>
