	...
	<section class="flyout">
		...
		<c:choose>
			<c:when test="${isLoggedin}">
				<div class="bd">
					<ul class="ui-list">
						<li class="import"> <a href="/bom-tool"><i class="ico-import"></i>${sImportTool}</a> </li>
						<sec:authorize access="!hasRole('ROLE_B2BEESHOPGROUP')">
			...
			<c:otherwise>
				<div class="bd">
					<ul class="ui-list">
						<li class="import"> <a href="/bom-tool"><i class="ico-import"></i><i class="ico-closed"></i>${sImportTool}</a> </li>
