...
<views:page-checkout pageTitle="${pageTitle}" bodyCSSClass="mod mod-layout mod-layout--checkout skin-layout-wide skin-layout-purchase">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-md-9">
					<mod:checkout-success template="pickup" skin="pickup" userId="${user.email}" orderCode="${order.code}" pickupLocation="${order.pickupLocation}" />
