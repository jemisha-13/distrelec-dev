...
<spring:message code="toolsitem.mark.favorite" var="sFavourite" />
...
<a class="ico ico-fav${isEShopGroup ? ' disabled' : ''} ${isEProcurement ? ' hidden' : ''}" title="<spring:message code='toolsitem.mark.favorite' />"
   data-product-code="${productId}"
   data-position="${positionIndex}"
   data-aainteraction="add to favourites" >
