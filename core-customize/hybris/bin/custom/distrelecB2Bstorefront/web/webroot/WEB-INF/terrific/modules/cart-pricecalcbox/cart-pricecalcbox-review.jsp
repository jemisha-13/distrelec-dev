...
<jsp:useBean id="dateTodayCheckoutBeanReview" class="java.util.Date"/>
<c:set var="dateToday">
	<fmt:formatDate value="${dateTodayCheckoutBeanReview}" dateStyle="short" timeStyle="short" type="date" pattern="${datePattern}" />
</c:set>
