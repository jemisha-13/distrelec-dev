...
<views:document-default pageTitle="${pageTitle}" bodyCSSClass="${bodyCSSClass}">
	...
	<div class="body-container">
		...
		<cms:slot var="feature" contentSlot="${slots['LeftSideContentPosition']}">
		...
		<div role="main" id="main" class="ct main-content-right locale__${currentCountry.isocode}__${currentLanguage.isocode}">
			<jsp:doBody />
		</div>
	</div>
