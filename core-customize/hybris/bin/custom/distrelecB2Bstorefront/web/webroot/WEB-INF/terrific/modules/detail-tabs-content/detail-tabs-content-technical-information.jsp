 ...
 <div class="validate-holder">
	 ...
	 <div class="searchsimilar ${!searchable ? 'hidden' : ''}">
		 ...
		 <div class="searchsimilar__holder">
			 <a class="mat-button btn-search disabled" data-search-url="${similarProductBaseUrl}" href="#"><i class="fa fa-search" aria-hidden="true"></i> <spring:message code="product.tabs.search.similar.products.title" /></a>
