(function ($) {
     ...
     * @extends Tc.Module
     */
    Tc.Module.BomMpnDuplicate = Tc.Module.extend({
        ...
        on: function (callback) {
            var self = this
                ...
                ,codeList = []
                ,$btnShowHideAlternative = $(".bom-mpn-product__show-alternative")
                ...
                $bomItemViewDetail =  this.$$('.bom-mpn-product__view-detail'),
                $modalViewDetail = $('.bom-mpn-product__modal', $ctx);

            $(".bom-mpn-product__show-alternative").on('click', function(e){
                var $alternativeContent = $(this).parents('.bom-mpn-product').find('.bom-mpn-product__alternatives'),
                $alternativeSelected = $(this).parents('.bom-mpn-product').find('.bom-mpn-product__alternatives-selection'),
                $alternativeProdInfo = $(this).parents('.bom-mpn-product').find(".bom-mpn-product__info");
            ...
            $('.bom-mpn-product__alternatives-selection .ico-list-rm').click(function(){

                var $item = $(this).parents('.bom-mpn-product__alternatives-selection'),
                    $btnShowHideAlternative = $(this).parents('.bom-mpn-product').find('.bom-mpn-product__show-alternative'),
                    $infoTitle = $(this).parents('.bom-mpn-product').find('.bom-mpn-product__info'),
                    $productcode = $(this).data('product-code'),
                    $infomsg = $(this).parents('.bom-mpn-product').find('.skin-global-messages-component');
                    $currentSelectdItem = $('.bom-mpn-product__item--'+$productcode),
                    $btnSelect = $currentSelectdItem.find('.bom-mpn-product__alternatives-select');
            ...
            $(".bom-mpn-product__alternatives-select").on('click', function(e){
                var productcode = $(this).data('product-code'),
                    ...
                    $showAlternative = $(this).parents('.bom-mpn-product').find(".bom-mpn-product__show-alternative"),
                    $alternativeProdInfo = $(this).parents('.bom-mpn-product').find(".bom-mpn-product__info"),
                    $alternativeProdItem = $(this).parents('.bom-mpn-product').find(".bom-mpn-product__item"),
                    $alternativeProdAlternatives = $(this).parents('.bom-mpn-product').find(".bom-mpn-product__alternatives"),
                    $alternativeProdItemCode = $(this).parents('.bom-mpn-product').find(".bom-mpn-product__item--" +productcode),
                    $allAlternativeSelect = $(this).parents('.bom-mpn-product').find(".bom-mpn-product__alternatives-select");
                ...
                $alternativeSelected.removeClass('hidden');
                $('.bom-mpn-product__alternatives-selection.selected .skin-product-bom').addClass('active');
