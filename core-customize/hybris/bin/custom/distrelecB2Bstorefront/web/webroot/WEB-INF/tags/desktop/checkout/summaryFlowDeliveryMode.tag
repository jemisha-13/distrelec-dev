...
<spring:url value="/checkout-not/summary/getDeliveryModes.json" var="getDeliveryModesUrl" />
<spring:url value="/checkout-not/summary/setDeliveryMode.json" var="setDeliveryModeUrl" />
...
/*<![CDATA[*/
	...
	{
		$('div.checkout_summary_flow_c .change_mode_button').click(function() {
