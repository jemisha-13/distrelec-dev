...
<spring:message code="home.login.favorite" text="Modal title" var="sModalTitle" />

<div class="modal-backdrop-fav modal-backdrop hidden">&nbsp;</div>
<div class="favorites-modal modal base" tabindex="-1">
    <div class="hd">
        <div class="hd__left">
    ...
    <form:form id="metaLoginForm_favourite" action="${loginAction}" method="post" modelAttribute="metaLoginForm">
        <div class="bd">
            <div class="error-box">
            ...
            <div class="form-row">
                ...
                <div class="field"><input name="j_username" id="j_username_favourites" placeholder="${sEmailPlaceholder}" class="fields validate-empty" tabindex="1" type="text" value=""></div>
            </div>
            <div class="form-row password">
                <formUtil:formLabel idKey="j_password" labelKey="lightboxloginrequired.password" path="" mandatory="false"/>
                <div class="field"><input name="j_password" id="j_password_favourites" placeholder="${sPassword}" class="fields validate-empty" tabindex="2" type="password" value=""></div>
            </div>
        </div>
        <div class="ft">
            <div class="left">
            ...
            <input type="hidden" id="customredirect" name="customredirect" value="/shopping/favorite" />
            <input type="submit" class="mat-button mat-button--action-red btn-fav" data-aainteraction="login button" value="${sLoginContinueBtn}" tabindex="4" />
        </div>
    </form:form>
</div>
