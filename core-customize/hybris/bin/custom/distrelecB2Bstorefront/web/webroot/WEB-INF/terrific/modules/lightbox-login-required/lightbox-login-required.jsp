...
<div class="modal base" tabindex="-1">
	...
	<form:form action="${loginAction}" method="post" modelAttribute="metaLoginForm">
		<div class="bd">
			<div class="error-box">
			...
			<div class="form-row">
				...
				<div class="field"><input name="j_username" id="j_username" class="field validate-empty" tabindex="1" type="text" value=""></div>
			</div>
			<div class="form-row">
				<formUtil:formLabel idKey="j_password" labelKey="lightboxloginrequired.password" path="" mandatory="false"/>
				<div class="field"><input name="j_password" id="j_password" class="field validate-empty" tabindex="2" type="password" value=""></div>
			</div>
			<div class="form-row">
				<form:checkbox id="j_remember_login-required" class="checkbox-big" path="_spring_security_remember_me" tabindex="3" />
		...
		<div class="ft">
			...
			<input type="hidden" id="customredirect" name="customredirect" value="/shopping" />
