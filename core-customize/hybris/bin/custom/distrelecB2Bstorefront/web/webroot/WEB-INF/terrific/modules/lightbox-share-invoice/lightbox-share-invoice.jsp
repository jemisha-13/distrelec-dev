...
<div class="modal modal-form-view base" tabindex="-1">
    <div class="hd">
        <div class="-left"> <h3 class="title">Email Invoice</h3> </div>
    ...
    <div class="bd">
        <div class="form-row">
            <label class="small" for="name_invoice"><spring:message code="toolsitem.share.your.name" /> *</label>
            <input name="name" id="name_invoice" maxlength="128" class="field ipt-big validate-empty" type="text" value="">
        </div>
        <div class="form-row"> <label class="small" for="email1_invoice"><spring:message code="toolsitem.share.your.email" /> *</label> </div>
        <div class="form-row"> <input name="email" id="email1_invoice" class="field ipt-big validate-email" type="text" value=""> </div>
        <div class="form-row"> <label class="small" for="email2_invoice"><spring:message code="toolsitem.share.receiver.email" /> *</label> </div>
        <div class="form-row"> <input name="email2" id="email2_invoice" class="field ipt-big validate-email" type="text" value=""> </div>
        <div class="form-row"> <label class="small" for="receivername_invoice"><spring:message code="toolsitem.share.receiver.name" /> *</label>
        	<input name="receivername" id="receivername_invoice" maxlength="128" class="field ipt-big validate-empty" type="text" value="">
        </div>
