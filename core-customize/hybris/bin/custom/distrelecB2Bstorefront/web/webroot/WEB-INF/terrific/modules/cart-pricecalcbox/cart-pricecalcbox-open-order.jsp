...
<c:set var="dateToday">
	<fmt:formatDate value="${dateToday}" dateStyle="short" timeStyle="short" type="date" pattern="${datePattern}" />
</c:set>

<c:set var="openOrderCloseLink" value="/checkout/openorder/changeOpenOrderInERP?code=${orderCode}&closeDate=${dateToday}" />
