(function($) {
	...
	Tc.Module.LightboxShareInvoice = Tc.Module.extend({
...
//            		self.sendForm(data.currentQueryUrl);
        ...
        sentSuccess: function (postData) {
            ...
            $(window).off('keydown.lightboxShareInvoice');
	        ...
	        $(window).on('keydown.lightboxShareInvoiceSent', function (e) {
                if (e.keyCode === 13) {
            ...
            self.$modalSent.find('.btn-ok').off('click').on('click', function () {
                $(window).off('keydown.lightboxShareInvoiceSent');
        ...
        sentError: function (postData) {
	        ...
	        $(window).on('keydown.lightboxShareInvoiceSentError', function (e) {
                if (e.keyCode === 13) {
            ...
            self.$modalSentError.find('.btn-cancel').off('click').on('click', function () {
                $(window).off('keydown.lightboxShareInvoiceSentError');
