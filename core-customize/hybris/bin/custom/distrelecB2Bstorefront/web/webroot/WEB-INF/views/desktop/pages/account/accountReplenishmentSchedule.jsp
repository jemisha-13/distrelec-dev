	...
	<div class="span-20 last">
		<div class="item_container_holder">
			<div class="title_holder">
				...
				<h2><spring:theme code="text.account.myReplenishment" text="My Replenishment Orders"/></h2>
			</div>
			<div class="item_container">
				<div class="item_container">
				<c:if test="${not empty searchPageData.results}">
					<p><spring:theme code="text.account.replenishment.manageReplenishmentSchedule" text="Manage Your Replenishment Schedule"/></p>
					<nav:pagination top="true"  supportShowPaged="${isShowPageAllowed}" supportShowAll="${isShowAllAllowed}" searchPageData="${searchPageData}" searchUrl="/my-account/my-replenishment?sort=${searchPageData.pagination.sort}" msgKey="text.account.replenishment.page"/>
					<form>
					...
					<nav:pagination top="false"  supportShowPaged="${isShowPageAllowed}" supportShowAll="${isShowAllAllowed}" searchPageData="${searchPageData}" searchUrl="/my-account/my-replenishment?sort=${searchPageData.pagination.sort}" msgKey="text.account.replenishment.page"/>
				</c:if>
