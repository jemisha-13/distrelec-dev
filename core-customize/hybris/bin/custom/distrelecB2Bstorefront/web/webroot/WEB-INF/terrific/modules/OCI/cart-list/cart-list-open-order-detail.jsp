...
<ul class="cart-list loading">
	<c:forEach var="orderEntry" items="${orderData.entries}">
		...
		<mod:cart-list-item template="order-detail" skin="order-detail" tag="li" htmlClasses="row${isDummyItem ? ' dummy-item' : '' }" orderEntry="${orderEntry}" isDummyItem="${isDummyItem}" />
	</c:forEach>
</ul>
