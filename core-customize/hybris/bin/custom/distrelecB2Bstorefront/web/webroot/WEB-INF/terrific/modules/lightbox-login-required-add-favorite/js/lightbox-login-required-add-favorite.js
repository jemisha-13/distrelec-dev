(function($) {
	 ...
	 * @extends Tc.Module
	 */
	Tc.Module.LightboxLoginRequiredAddFavorite = Tc.Module.extend({
        ...
        onOpenModal: function () {
            ...
            $(window).on('keydown.LightboxLoginRequiredAddFavorite', function (e) {
                if (e.keyCode === 13) {
        ...
        hideModal: function () {
            ...
            $(window).off('keydown.LightboxLoginRequiredAddFavorite');
        },
