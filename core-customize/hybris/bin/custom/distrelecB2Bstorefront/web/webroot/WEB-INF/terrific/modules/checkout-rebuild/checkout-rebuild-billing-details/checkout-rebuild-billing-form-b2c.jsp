...
<c:forEach items="${supportedRegisterCountries}" var="registerCountry">
    <c:if test="${registerCountry.isocode eq b2CAddressForm.countryIso}">
...
<c:choose>
    <c:when test="${siteUid eq 'distrelec_EX' and isCountrySupported}">
        <spring:message code="register.postalCode.validationPattern_${b2CAddressForm.countryIso}" var="postalCodePattern" />
        <spring:message code="register.postalCode.validationMessage_${b2CAddressForm.countryIso}" var="postalCodeErrorMessage"/>
    </c:when>
    <c:otherwise>
...
<div class="o-bf js-inline-validation" data-iv-validate-previous-elements="true"
    ...
    <form:form modelAttribute="b2CAddressForm" class="js-iv-form js-billing-form" data-customer-type="${template}">
        ...
        <div class="row">
            <div class="col-md-6">
                <formUtil:ux-formSelect selectId="billingTitleSelect"
                    ...
                    <div id="b2cBillingFieldErrorEmpty_title" class="js-iv-errors-empty" hidden>
        ...
        <div class="row">
            <div class="col-md-6">
                <formUtil:ux-formInput inputId="billingFirstNameInput"
                    ...
                    <div id="b2cBillingFieldErrorEmpty_firstName" class="js-iv-errors-empty" hidden>
            ...
            <div class="col-md-6">
                <formUtil:ux-formInput inputId="billingLastNameInput"
                                       ...
                                       maxLength="40"
                                       inputAttributes="data-iv-triggers='change' data-iv-errors='empty'">
                    <div id="b2cBillingFieldErrorEmpty_lastName" class="js-iv-errors-empty" hidden>
        ...
        <div class="row">
            <div class="col-12">
                <formUtil:ux-formInput inputId="billingAddressLine1Input"
                                       ...
                                       maxLength="60"
                                       inputAttributes="data-iv-triggers='change' data-iv-errors='empty'">
                    <div id="b2cBillingFieldErrorEmpty_line1" class="js-iv-errors-empty" hidden>
        ...
        <div class="row">
            <div class="col-12">
                <formUtil:ux-formInput inputId="billingTownInput"
                                       ...
                                       maxLength="40"
                                       inputAttributes="data-iv-triggers='change' data-iv-errors='empty'">
                    <div id="b2cBillingFieldErrorEmpty_town" class="js-iv-errors-empty" hidden>
                ...
                <c:choose>
                    <c:when test="${fn:length(countries) gt 1}">
                        <formUtil:ux-formSelect selectId="billingCountrySelect"
                                                ...
                                                selectAttributes="data-iv-triggers='change' data-iv-errors='empty'">
                            <div id="b2cBillingFieldErrorEmpty_countries" class="js-iv-errors-empty" hidden>
                    ...
                    <c:otherwise>
                        <div class="ux-form-group">
                            <c:choose>
                                <c:when test="${not empty b2CAddressForm.countryIso}">
                                    <c:set var="countryIso" value="${b2CAddressForm.countryIso}"/>
                                    <c:forEach items="${billingAddressCountries}" var="billingCountry">
                                        <c:if test="${billingCountry.isocode eq b2CAddressForm.countryIso}">
                            ...
                            <label id="b2cBillingCountryLabel" class="ux-form-group__label"><spring:message
                                    code="checkout.address.country"/></label>
                            <input name="countryIso" value="${countryIso}" type="hidden">
                            <div>
                                <strong id="b2cBillingCountryName" class="fw-b">${countryName}</strong>
                            </div>
                        </div>
                    </c:otherwise>
                </c:choose>
        ...
        <div class="row">
            <div class="col-6">
                <formUtil:ux-formInput inputId="billingPostalCodeInput"
                    ...
                    <div id="b2cBillingFieldErrorPostalCode" class="js-iv-errors-postalCode"
                         hidden>${postalCodeErrorMessage}</div>
                </formUtil:ux-formInput>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <formUtil:ux-formInput inputId="billingPhoneInput"
                    ...
                    <div id="b2cBillingFieldErrorPhoneNumber" class="js-iv-errors-phonenumber" hidden>
        ...
        <div class="row">
            <div class="col-12">
                <div class="o-cr-editable-form__ctas">
                    <button id="b2cBillingSubmitButton"
                            class="ux-btn ux-btn--brand-green is-grey-when-disabled w-auto js-iv-form-submit js-billing-form-submit"
                            type="button" disabled>
                        <spring:message code="checkout.rebuild.billing.form.submit.button"/>
                    </button>

                    <c:if test="${showBillingEdit}">
                        <button id="b2cBillingCancelButton"
                                class="ux-btn ux-btn--white-light w-auto js-cr-editableform-cancel is-cancel-btn"
                                type="button">
