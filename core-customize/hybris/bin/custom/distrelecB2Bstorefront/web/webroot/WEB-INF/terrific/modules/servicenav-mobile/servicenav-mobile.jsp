...
<div class="fsettingsContainer">
	...
	<div class="formSettingsContainerMobile shopsetings-popup transparent">
		<script id="template-lightboxshopsettings-mobile" type="text/x-template-dotjs">
			<section class="flyout-settings-mobile">
				<div class="flyout-settings-mobile__holder">
					<div class="hd">
					...
					<form:form action="/_s/shopsettings" method="post" id="shopSettingMobile">
						<div class="bd">
							<div class="bd__item">
								<label for="select-country-mobile">${sCountryLabel}</label>
								<select id="select-country-mobile" name="country" ${disabled} class="selectpicker js-selectCountryMobile"></select>
							</div>
							<div class="bd__item">
								<label for="select-language-mobile">${sLanguageLabel}</label>
								<select id="select-language-mobile" name="language" class="selectpicker selectpicker--language"></select>
							</div>
							<div class="bd__item">
								<label for="select-channel-mobile">${sChannelLabel}</label>
								<select id="select-channel-mobile" name="channel" class="selectpicker selectpicker--channel"></select>
							</div>
						</div>
						<div class="ft">
							<div class="ft-holder">
							...
							<input type="submit" class="btn btn-primary btn-save" value="${sSave}" data-label-default="${sSave}" data-label-redirect="${sRedirect}" />
						</div>
					</form:form>
				</div>
			</section>
		...
		<script id="template-lightboxshopsettings-option-mobile" type="text/x-template-dotjs">
			<option data-icon="icon-{{=it.name}}" value="{{=it.key}}">{{=it.keyLabel}}</option>
		</script>

	</div>
</div>
<script id="template-servicenav-settings-mobile" type="text/x-template-dotjs">
	<ul>
		<li class="border red">
