...
<terrific:mod name="servicenav-mobile" tag="${tag}" htmlClasses="${htmlClasses}" skin="${skin}" dataConnectors="${dataConnectors}" attributes="${attributes}">
    <%@ include file="/WEB-INF/terrific/modules/servicenav-mobile/servicenav-mobile.jsp" %>
</terrific:mod>