		...
		<div class="item_container_holder">
			...
			<div class="item_container">
				<c:if test="${not empty searchPageData.results}">
					<p><spring:theme code="text.account.quoteHistory.viewOrders" text="View your orders"/></p>
					<nav:pagination top="true"  supportShowPaged="${isShowPageAllowed}" supportShowAll="${isShowAllAllowed}" searchPageData="${searchPageData}" searchUrl="/my-account/my-quotes?sort=${searchPageData.pagination.sort}" msgKey="text.account.orderHistory.page"/>
					<form>
					...
					<nav:pagination top="false"  supportShowPaged="${isShowPageAllowed}" supportShowAll="${isShowAllAllowed}" searchPageData="${searchPageData}" searchUrl="/my-account/my-quotes?sort=${searchPageData.pagination.sort}" msgKey="text.account.orderHistory.page"/>
				</c:if>
