...
<div class="skin-cart-list-cart__content cart-list loading">
	...
	<c:forEach var="orderEntry" items="${cartData.entries}" varStatus="status">
		...
		<mod:cart-list-item tag="div" orderEntry="${orderEntry}" showMyPrice="${showMyPrice}" showListPrice="${showListPrice}" template="cart" skin="cart" htmlClasses="${BOMClass}${quoteClass}${dummyClass} quote-item-checkout-row-${isQuoteItem}"
