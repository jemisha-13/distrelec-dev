...
<spring:url value="/checkout-not/summary/getSavedCards.json" var="getSavedCardsUrl" />
<spring:url value="/checkout-not/summary/setPaymentDetails.json" var="setPaymentDetailsUrl"/>
<spring:url value="/checkout-not/summary/getPaymentDetailsForm.json" var="getPaymentDetailsFormUrl"/>
