...
<div class="modal js-rohsAdditionalInformation" tabindex="-1">
    ...
    <button id="rohs.underReview.continueShopping" class="btn btn-primary" data-dismiss="modal" aria-hidden="true"><spring:message code="rohs.underReview.continueShopping"/></button>
</div>
