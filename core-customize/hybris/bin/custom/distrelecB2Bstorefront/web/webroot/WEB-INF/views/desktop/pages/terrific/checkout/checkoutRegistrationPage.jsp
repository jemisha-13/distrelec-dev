...
<spring:theme code="login.cancelandreturn" text="Return to cart" var="sCancelText"/>
<spring:theme code="login.newto.title" text="New to Distrelec" var="sNewToTitle"/>
<spring:theme code="login.newto.text" text="Register now and checkout, it only takes a minute!" var="sNewToText"/>
...
<views:page-checkout pageTitle="${pageTitle}" bodyCSSClass="mod mod-layout mod-layout--checkout mod-layout--checkout-registration skin-layout-wide mod-layout--standalone">
