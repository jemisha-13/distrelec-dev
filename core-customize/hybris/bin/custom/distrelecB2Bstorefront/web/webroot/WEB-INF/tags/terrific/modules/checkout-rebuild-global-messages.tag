...
<terrific:mod name="checkout-rebuild-global-messages" tag="${tag}" htmlClasses="${htmlClasses}" skin="${skin}" dataConnectors="${dataConnectors}" attributes="${attributes}">
	<%@ include file="/WEB-INF/terrific/modules/checkout-rebuild/checkout-rebuild-global-messages.jsp" %>
</terrific:mod>
