...
<div id="currentTypeahea$directOrder0" class="quickorder quickorder--component">
	...
	<ul>
		...
		<li><a href="/bom-tool" data-aasectionpos="c3r1"
			   data-aasectiontitle="Welcome to Distrelec"
			   data-aabuttonpos="4"
			   data-aalinktext="BOM Tool"
			   data-aatype="homepage-interaction"
		><spring:message code="metahd.lists.import-tool" /></a></li>
		<li><a <c:if test="${isLoggedIn eq false}">class="ico-list"</c:if> href="/shopping" data-aasectionpos="c3r1"
			   data-aasectiontitle="Welcome to Distrelec"
			   data-aabuttonpos="5"
			   data-aalinktext="Shopping List"
			   data-aatype="homepage-interaction"
		><spring:message code="metahd.lists.shopping-list.loggedout"/></a></li>
	</ul>
