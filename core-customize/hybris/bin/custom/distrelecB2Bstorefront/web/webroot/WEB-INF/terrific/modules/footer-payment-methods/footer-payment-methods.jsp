...
<ul class="${mainCssClass}__list">
	<c:forEach items="${paymentMethods}" var="paymentMethodItem">
		<c:set var="listItem">
			<span class="${mainCssClass}__list__wrapper__image"><img class="image" data-src="${paymentMethodItem.icon.url}" alt="${paymentMethodItem.title}" /></span>
