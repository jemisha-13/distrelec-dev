...
<div class="xmod-facets plp-filter-search-facets">
	...
	<div class="xmod-facets__more-scroll-wrapper">
        ...
        <a href="#" class="xmod-facets__more-scroll-link hidden">
            <i class="fas fa-chevron-circle-right"></i>
            <span class="title"> <spring:message code="cart.directorder.add.more" /> </span>
        </a>
													...
													<c:when test="${(facet.type.value eq 'checkbox')}">
														...
														>
															...
															<span href="${facetValueQueryUrl}" class="facet-item__anchor ${facetValue.selected ? 'active' : ''}" name="${wtTeaserTrackingIdFaf}.f-${facetValueNameWtLower}.-" title="${facetValueName}">
																...
																<span class="facet-item__anchor__name"> ${facetValueNameDisplay}
                                                                    &nbsp;<b>(</b><span class="product-count"><spring:theme code="search.nav.facetValueCount" arguments="${facetValue.count}"/></span><b>)</b>
                                                                </span>
															</span>
