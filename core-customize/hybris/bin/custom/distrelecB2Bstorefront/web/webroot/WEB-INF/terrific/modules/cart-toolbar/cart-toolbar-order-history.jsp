...
<div class="item btns">
	<div class="btns__left">
		<c:if test="${not empty orderHistoryData}">
			...
			<mod:toolsitem template="toolsitem-download" skin="download skin-toolsitem-narrow" tag="div" downloadUrl="/my-account/order-history/order-details/${orderHistoryData.code}/download" orderIndex="${orderIndex}" attributes="data-aaorder-id='${orderHistoryData.code}',data-aainteraction='download order details',data-aalocation='order history'" />
