...
<terrific:mod name="hero-teaser" tag="aside" htmlClasses="${htmlClasses}" skin="${skin}" dataConnectors="${dataConnectors}" attributes="${attributes}">
	<%@ include file="/WEB-INF/terrific/modules/hero-teaser/hero-teaser.jsp" %>
</terrific:mod>
