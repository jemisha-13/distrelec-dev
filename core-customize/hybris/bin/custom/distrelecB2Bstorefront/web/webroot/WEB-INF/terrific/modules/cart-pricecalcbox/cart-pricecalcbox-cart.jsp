...
<spring:theme code="cart.pricecalcbox.reevo.tooltip" var="sTooltipText" />
...
<jsp:useBean id="dateTodayCheckoutBean" class="java.util.Date"/>
<c:set var="dateToday">
	<fmt:formatDate value="${dateTodayCheckoutBean}" dateStyle="short" timeStyle="short" type="date" pattern="${datePattern}" />
</c:set>
...
<c:if test="${ currentCountry.isocode == 'DE' }">
     <div class="reevo-container">
        <div class="reevo-checkbox-container">
            <input type="checkbox" id="reevo-checkbox" class="js-reevo-checkbox reevo-checkbox"/>
        </div>

        <div class="reevo-label-container">
            <label for="reevo-checkbox">
                <span class="reevo-label">
                    <spring:theme code="cart.pricecalcbox.reevo.message1"/>
                    <br/>
                    <spring:theme code="cart.pricecalcbox.reevo.message2"/>
                    <i class="fa fa-info-circle" data-title="${sTooltipText}"></i>
                </span>
            </label>
        </div>
    </div>
