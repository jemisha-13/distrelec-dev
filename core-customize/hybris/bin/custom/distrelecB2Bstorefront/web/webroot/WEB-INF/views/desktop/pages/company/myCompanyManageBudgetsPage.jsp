	...
	<nav:myCompanyNav selected="budgets"/>
		...
		<div class="item_container_holder">
			<div class="title_holder">
				...
				<h2><spring:theme code="text.company.manage.budget.title" text="All Budgets"/></h2>
			</div>
			<div class="right last">
					<a href="${addBudgetUrl}">
						<button class="positive right pad_right place-order" id="CreateNewBudget_button">
									<spring:theme code="text.company.budget.createButton.displayName" />
						</button>
					</a>
			</div>
			...
			<div class="item_container">
				...
				<nav:pagination top="true" supportShowPaged="${isShowPageAllowed}" supportShowAll="${isShowAllAllowed}" searchPageData="${searchPageData}" searchUrl="/my-company/organization-management/manage-budgets?sort=${searchPageData.pagination.sort}" msgKey="text.company.budget.page" />
				...
				<nav:pagination top="false"  supportShowPaged="${isShowPageAllowed}" supportShowAll="${isShowAllAllowed}" searchPageData="${searchPageData}" searchUrl="/my-company/organization-management/manage-budgets?sort=${searchPageData.pagination.sort}" msgKey="text.company.budget.page" />
