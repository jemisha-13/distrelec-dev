...
<a class="ico ico-list ico-shopping ${isEShopGroup ? ' disabled' : ''} ${isEProcurement ? ' hidden' : ''}"
	...
	<span class="addto" title="<spring:message code='cartTabs.title.shoppingList' />"> <spring:message code='cartTabs.title.shoppingList' /> </span>
</a>
