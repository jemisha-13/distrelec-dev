...
<div class="bannner-normal" >
        ...
        <img class="bannner-normal__img" alt="${not empty headline ? headline : component.name}" data-src="${media.url}" width="178" height="57" title="${sTitle}" />
