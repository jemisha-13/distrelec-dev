	...
	<div class="image-wrap">
		<a href="${product.url}">
			...
			<picture>
				...
				<img alt="${landscapeSmallAlt}" src="${landscapeSmallJpg}"/>
			</picture>
		</a>
	</div>
...
<div class="cell cell-info base" data-delivery-id="${orderEntry.deliveryId}" data-delivery-quantity="${orderEntry.deliveryQuantity}" data-tracking-url="${orderEntry.deliveryTrackingUrl}">
	<c:choose>
