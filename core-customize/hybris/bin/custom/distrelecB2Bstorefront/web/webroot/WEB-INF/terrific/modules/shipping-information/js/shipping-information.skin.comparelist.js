(function($) {
	 ...
	 * @constructor
	 */
	Tc.Module.ShippingInformation.Comparelist = function (parent) {
		...
		this.on = function (callback) {
			...
			var $moreAboutLeadLink = $('.moreAboutLeadLink');
			...
			$(document).click(function(e) {
			    ...
			    if (className !== 'moreAboutLeadLink ellipsis' && className !== 'lead-closer' && className !== 'leadTimeFlyout' && 
			    		className !== 'moreAboutLeadLink' && className !== 'inStockLong' && className !== 'furtherLong'){
