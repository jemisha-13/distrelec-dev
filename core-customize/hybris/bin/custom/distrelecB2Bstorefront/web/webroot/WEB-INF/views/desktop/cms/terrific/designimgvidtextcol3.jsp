...
<article id="distcomp-14" class="container bannner bannner-component bannner-component--fourteen bannner-component--fourteen-col3">
	<div class=" row">
		<div class="col-md-4">
		...
		<div class="col-md-4">
			<div class="bannner__content">
				<c:if test="${not empty image3.URL}">
					<div class="bannner__content--image">
						<img alt="${headline}" src="${image3.URL}">
					</div>
				</c:if>
				<c:if test="${not empty video3.youtubeUrl}">
					<div class="bannner__content--video">
						<iframe width="560" height="315" src="${video3.youtubeUrl}"></iframe>
					</div>
				</c:if>
				<c:if test="${not empty text3}">
					<div class="bannner__content--description">
						${text3}
					</div>
				</c:if>
