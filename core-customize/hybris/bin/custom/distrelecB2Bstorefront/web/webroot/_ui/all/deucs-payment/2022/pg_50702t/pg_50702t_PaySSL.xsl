        ...
        <html class="">
            ...
            <head>
                ...
                <style type="text/css">
                    ...
                    src: url("Templates/imagespg_50702t/Montserrat-Bold.woff2") format("woff2"), url("Templates/imagespg_50702t/Montserrat-Bold.woff") format("woff");
                    font-weight: bold;
                    font-display: swap;
                    ...
                    @font-face {
                    font-family: 'Montserrat';
                    src: url("Templates/imagespg_50702t/Montserrat-SemiBold.woff2") format("woff2"), url("Templates/imagespg_50702t/Montserrat-SemiBold.woff") format("woff");
                    font-weight: 600;
                    font-display: swap;
                    unicode-range: U+0600-U+06FF,U+1D400—U+1D7FF,U+0590—U+05FF,U+4E00-U+9FFF,U+3400-U+4DBF,U+20000-U+2A6DF, U+2A700–U+2B73F,U+2B740–U+2B81F,U+2B820–U+2CEAF,U+F900-U+FAFF,U+2F800-U+2FA1F,U+0370—U+03FF,U+1D300—U+1D35F U+0700—U+074F,U+0F00—U+0FFF,U+1000—U+109F,U+1200—U+137F,U+1100—U+11FF,U+A500—U+A63F;
                    }
                    ...
                    @font-face {
                    font-family: 'Montserrat';
                    src: url("Templates/imagespg_50702t/Montserrat-Regular.woff2") format("woff2"), url("Templates/imagespg_50702t/Montserrat-Regular.woff") format("woff");
                    font-weight: normal;
                    font-display: swap;
                    unicode-range: U+0600-U+06FF,U+1D400—U+1D7FF,U+0590—U+05FF,U+4E00-U+9FFF,U+3400-U+4DBF,U+20000-U+2A6DF, U+2A700–U+2B73F,U+2B740–U+2B81F,U+2B820–U+2CEAF,U+F900-U+FAFF,U+2F800-U+2FA1F,U+0370—U+03FF,U+1D300—U+1D35F U+0700—U+074F,U+0F00—U+0FFF,U+1000—U+109F,U+1200—U+137F,U+1100—U+11FF,U+A500—U+A63F;
                    }
                    ...
                    @font-face {
                    font-family: 'Montserrat';
                    src: url("Templates/imagespg_50702t/Montserrat-Medium.woff2") format("woff2"), url("Templates/imagespg_50702t/Montserrat-Medium.woff") format("woff");
                    font-weight: 500;
                    font-display: swap;
                    unicode-range: U+0600-U+06FF,U+1D400—U+1D7FF,U+0590—U+05FF,U+4E00-U+9FFF,U+3400-U+4DBF,U+20000-U+2A6DF, U+2A700–U+2B73F,U+2B740–U+2B81F,U+2B820–U+2CEAF,U+F900-U+FAFF,U+2F800-U+2FA1F,U+0370—U+03FF,U+1D300—U+1D35F U+0700—U+074F,U+0F00—U+0FFF,U+1000—U+109F,U+1200—U+137F,U+1100—U+11FF,U+A500—U+A63F;
                    }
                    ...
                    <div class="payssl" style="display: block; float: left; width: 100%;">
                            ...
                            <div class="payssl__field--cardno__input-wrapper">
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <img class="is-chevron" height="20" width="20" src="Templates/imagespg_50702t/chevron.svg" title="Chevron down"/>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </div>
                        ...
                        <div class="payssl__field payssl__field--cardno">
                            ...
                            <div class="payssl__field--cardno__input-wrapper">
                                ...
                                <xsl:if test="/paygate/PCNr = ''">
                                    <img class="is-lock" height="20" width="20" src="Templates/imagespg_50702t/lock.svg" title="Lock icon"/>
                                </xsl:if>
                            </div>
