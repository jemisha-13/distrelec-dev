...
public class ProductReferencesComponentControllerTest {
    ...
    public void testRenderComponent() throws Exception {
        ...
        given(productReferencesComponentModel.getProductReferenceTypes()).willReturn(Collections.singletonList(ProductReferenceTypeEnum.ACCESSORIES));
        ...
        given(productFacade.getProductReferencesForCode(Mockito.anyString(), Mockito.anyListOf(ProductReferenceTypeEnum.class), Mockito.any(List.class),
                Mockito.<Integer>any())).willReturn(productReferenceDataList);

        final String viewName = productReferencesComponentController.handleComponent(request, response, model, productReferencesComponentModel);
