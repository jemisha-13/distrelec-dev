...
public class MultiReplaceTextDecoratorTest extends ServicelayerTransactionalTest {
    ...
    public void testDecorate() throws Exception {
        ...
        final org.springframework.core.io.Resource res = FileUtils.createResourceFromFilepath("/test/importexport/MultiReplaceTextDecorator.impex", true);
        ...
        Assert.assertEquals("Description wasn't 'bbcfef'.", "bbcfef", product.getDescription());
    }
