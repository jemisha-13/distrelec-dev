...
/**
 * Provides necessary meta information about the nami18n hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class Nami18nHMCExtension extends HMCExtension {
    /** Edit the local|project.properties to change logging behavior (properties log4j.*). */
    @SuppressWarnings("unused")
    private static final Logger LOG = Logger.getLogger(Nami18nHMCExtension.class.getName());

    /** Path to the resource bundles. */
    public final static String RESOURCE_PATH = "com.namics.hybris.i18n.hmc.locales";
